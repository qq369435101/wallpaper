...
public class DateFormatUtils {
    ...
    private static final String DATE_FORMAT_PATTERN_MS="mm:ss";
     ...
     * @return 格式化的日期字符串
     */
    public static String long2StrMS(long timestamp) {
        return long2Str(timestamp,DATE_FORMAT_PATTERN_MS);
    }
